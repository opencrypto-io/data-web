...
var LastCommit = {
  ...
  view: function () {
    ...
    return m("div", [m("div.is-hidden-mobile", "Last commit: "), m("a", { href: "https://github.com/opencrypto-io/data/commits/master", title: metadata.commit }, commitShort), m("span", " (" + moment(metadata.time).fromNow() + ")")]);
  }
};
